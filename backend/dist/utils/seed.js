...
const seedData = async () => {
    try {
        ...
        await CMSPage_1.default.deleteMany({});
        await CMSSection_1.default.deleteMany({});
        ...
        const coupons = await Coupon_1.default.create([
            {
                code: 'VELORA10',
        ...
        // Home Page CMS
        const homePage = await CMSPage_1.default.create({
            pageKey: 'home',
        ...
        await CMSSection_1.default.create([
            {
                pageKey: 'home',
                sectionKey: 'hero',
                order: 1,
